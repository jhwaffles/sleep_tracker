...
SELECT
    id,
    cast(day AS date),
    cast(awake_time AS INT),
    cast(bedtime_end AS timestamptz),
    cast(bedtime_start AS timestamptz),
    time_in_bed::INTEGER AS time_in_bed_duration,
    cast(deep_sleep_duration AS INT),
    cast(rem_sleep_duration AS int),
    cast(total_sleep_duration AS INT),
    latency::INTEGER AS latency_duration, 
    cast(light_sleep_duration AS INT),
    cast(efficiency AS INT),
